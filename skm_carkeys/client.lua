...
function getVehicleInDirection(a, b)
    local rayHandle = CastRayPointToPoint(a.x, a.y, a.z, b.x, b.y, b.z, 10, GetPlayerPed(-1), 0)
...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        if(IsControlJustPressed(1, 303)) then 
            ...
            local plrCoords_bis = GetOffsetFromEntityInWorldCoords(plr, 0.0, 10.0, 0.0)
            ...
            if(IsPedInAnyVehicle(plr, true))then
                ...
                if GetVehicleNumberPlateText(getVehicleInDirection(plrCoords, plrCoords_bis)) ~= nil then
                    
                    local localVehId = getVehicleInDirection(plrCoords, plrCoords_bis)
                    local localVehPlate = string.lower(GetVehicleNumberPlateText(localVehId))
